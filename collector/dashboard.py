  ...
  <div class="connect-panel">
    ...
    <div class="connect-body">
      <div id="connectChooser" class="connect-view active">
        ...
        <div class="connect-grid">
          <button class="connect-card" type="button" onclick="showConnectDetail('openai')"><span class="brand-mark openai"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/ChatGPT_logo.svg/1200px-ChatGPT_logo.svg.png" alt="OpenAI" style="width:23px;height:23px;object-fit:contain" onerror="this.style.display='none';this.nextElementSibling.style.display='inline'"><span class="brand-fallback">O</span></span><span><span class="name">OpenAI</span><span class="desc">Protect Responses and Chat Completions through the SDK.</span></span></button>
          <button class="connect-card" type="button" onclick="showConnectDetail('anthropic')"><span class="brand-mark anthropic"><img src="https://cdn.simpleicons.org/anthropic/7B3F00" alt="Anthropic" style="width:23px;height:23px;object-fit:contain;filter:brightness(0) invert(1)" onerror="this.style.display='none';this.nextElementSibling.style.display='inline'"><span class="brand-fallback">A</span></span><span><span class="name">Anthropic</span><span class="desc">Protect Claude requests and tool-use workflows.</span></span></button>
        </div>
